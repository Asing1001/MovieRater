...
function getMaybePagePath(page, distDir, locales, isAppPath) {
    ...
    if (isAppPath) {
        appPathsManifest = (0, _loadmanifestexternal.loadManifest)(_path.default.join(serverBuildPath, _constants.APP_PATHS_MANIFEST), !isDev);
    }
    const pagesManifest = (0, _loadmanifestexternal.loadManifest)(_path.default.join(serverBuildPath, _constants.PAGES_MANIFEST), !isDev);
    try {
