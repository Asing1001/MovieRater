module.exports = [
"[project]/node_modules/undici/lib/dispatcher/dispatcher.js [instrumentation] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/undici/lib/dispatcher/dispatcher-base.js [instrumentation] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const UnwrapHandler = __turbopack_context__.r("[project]/node_modules/undici/lib/handler/unwrap-handler.js [instrumentation] (ecmascript)");
const { ClientDestroyedError, ClientClosedError, InvalidArgumentError } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/errors.js [instrumentation] (ecmascript)");
const { kDestroy, kClose, kClosed, kDestroyed, kDispatch } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/symbols.js [instrumentation] (ecmascript)");
...
"[project]/node_modules/undici/lib/dispatcher/client-h1.js [instrumentation] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const { RequestContentLengthMismatchError, ResponseContentLengthMismatchError, RequestAbortedError, HeadersTimeoutError, HeadersOverflowError, SocketError, InformationalError, BodyTimeoutError, HTTPParserError, ResponseExceededMaxSizeError } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/errors.js [instrumentation] (ecmascript)");
const { kUrl, kReset, kClient, kParser, kBlocking, kRunning, kPending, kSize, kWriting, kQueue, kNoRef, kKeepAliveDefaultTimeout, kHostHeader, kPendingIdx, kRunningIdx, kError, kPipelining, kSocket, kKeepAliveTimeoutValue, kMaxHeadersSize, kKeepAliveMaxTimeout, kKeepAliveTimeoutThreshold, kHeadersTimeout, kBodyTimeout, kStrictContentLength, kMaxRequests, kCounter, kMaxResponseSize, kOnError, kResume, kHTTPContext, kClosed } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/symbols.js [instrumentation] (ecmascript)");
const constants = __turbopack_context__.r("[project]/node_modules/undici/lib/llhttp/constants.js [instrumentation] (ecmascript)");
const EMPTY_BUF = Buffer.alloc(0);
const FastBuffer = Buffer[Symbol.species];
const removeAllListeners = util.removeAllListeners;
let extractBody;
function lazyllhttp() {
    const llhttpWasmData = process.env.JEST_WORKER_ID ? __turbopack_context__.r("[project]/node_modules/undici/lib/llhttp/llhttp-wasm.js [instrumentation] (ecmascript)") : undefined;
    let mod;
    ...
    if (useWasmSIMD) {
        try {
            mod = new WebAssembly.Module(__turbopack_context__.r("[project]/node_modules/undici/lib/llhttp/llhttp_simd-wasm.js [instrumentation] (ecmascript)"));
        } catch  {}
    }
    if (!mod) {
        ...
        mod = new WebAssembly.Module(llhttpWasmData || __turbopack_context__.r("[project]/node_modules/undici/lib/llhttp/llhttp-wasm.js [instrumentation] (ecmascript)"));
    }
 ...
 */ function writeH1(client, request) {
    ...
    if (util.isFormDataLike(body)) {
        if (!extractBody) {
            extractBody = __turbopack_context__.r("[project]/node_modules/undici/lib/web/fetch/body.js [instrumentation] (ecmascript)").extractBody;
        }
...
"[project]/node_modules/undici/lib/dispatcher/client-h2.js [instrumentation] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const util = __turbopack_context__.r("[project]/node_modules/undici/lib/core/util.js [instrumentation] (ecmascript)");
const { RequestContentLengthMismatchError, RequestAbortedError, SocketError, InformationalError, InvalidArgumentError } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/errors.js [instrumentation] (ecmascript)");
const { kUrl, kReset, kClient, kRunning, kPending, kQueue, kPendingIdx, kRunningIdx, kError, kSocket, kStrictContentLength, kOnError, kMaxConcurrentStreams, kPingInterval, kHTTP2Session, kHTTP2InitialWindowSize, kHTTP2ConnectionWindowSize, kResume, kSize, kHTTPContext, kClosed, kBodyTimeout, kEnableConnectProtocol, kRemoteSettings, kHTTP2Stream, kHTTP2SessionState } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/symbols.js [instrumentation] (ecmascript)");
const { channels } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/diagnostics.js [instrumentation] (ecmascript)");
...
"[project]/node_modules/undici/lib/dispatcher/client.js [instrumentation] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const util = __turbopack_context__.r("[project]/node_modules/undici/lib/core/util.js [instrumentation] (ecmascript)");
const { ClientStats } = __turbopack_context__.r("[project]/node_modules/undici/lib/util/stats.js [instrumentation] (ecmascript)");
const { channels } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/diagnostics.js [instrumentation] (ecmascript)");
const Request = __turbopack_context__.r("[project]/node_modules/undici/lib/core/request.js [instrumentation] (ecmascript)");
const DispatcherBase = __turbopack_context__.r("[project]/node_modules/undici/lib/dispatcher/dispatcher-base.js [instrumentation] (ecmascript)");
const { InvalidArgumentError, InformationalError, ClientDestroyedError } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/errors.js [instrumentation] (ecmascript)");
const buildConnector = __turbopack_context__.r("[project]/node_modules/undici/lib/core/connect.js [instrumentation] (ecmascript)");
const { kUrl, kServerName, kClient, kBusy, kConnect, kResuming, kRunning, kPending, kSize, kQueue, kConnected, kConnecting, kNeedDrain, kKeepAliveDefaultTimeout, kHostHeader, kPendingIdx, kRunningIdx, kError, kPipelining, kKeepAliveTimeoutValue, kMaxHeadersSize, kKeepAliveMaxTimeout, kKeepAliveTimeoutThreshold, kHeadersTimeout, kBodyTimeout, kStrictContentLength, kConnector, kMaxRequests, kCounter, kClose, kDestroy, kDispatch, kLocalAddress, kMaxResponseSize, kOnError, kHTTPContext, kMaxConcurrentStreams, kHTTP2InitialWindowSize, kHTTP2ConnectionWindowSize, kResume, kPingInterval } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/symbols.js [instrumentation] (ecmascript)");
const connectH1 = __turbopack_context__.r("[project]/node_modules/undici/lib/dispatcher/client-h1.js [instrumentation] (ecmascript)");
const connectH2 = __turbopack_context__.r("[project]/node_modules/undici/lib/dispatcher/client-h2.js [instrumentation] (ecmascript)");
...
"[project]/node_modules/undici/lib/dispatcher/fixed-queue.js [instrumentation] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/undici/lib/dispatcher/pool-base.js [instrumentation] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";

const { PoolStats } = __turbopack_context__.r("[project]/node_modules/undici/lib/util/stats.js [instrumentation] (ecmascript)");
const DispatcherBase = __turbopack_context__.r("[project]/node_modules/undici/lib/dispatcher/dispatcher-base.js [instrumentation] (ecmascript)");
const FixedQueue = __turbopack_context__.r("[project]/node_modules/undici/lib/dispatcher/fixed-queue.js [instrumentation] (ecmascript)");
const { kConnected, kSize, kRunning, kPending, kQueued, kBusy, kFree, kUrl, kClose, kDestroy, kDispatch } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/symbols.js [instrumentation] (ecmascript)");
...
"[project]/node_modules/undici/lib/dispatcher/pool.js [instrumentation] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";

const { PoolBase, kClients, kNeedDrain, kAddClient, kGetDispatcher, kRemoveClient } = __turbopack_context__.r("[project]/node_modules/undici/lib/dispatcher/pool-base.js [instrumentation] (ecmascript)");
...
const util = __turbopack_context__.r("[project]/node_modules/undici/lib/core/util.js [instrumentation] (ecmascript)");
const { kUrl } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/symbols.js [instrumentation] (ecmascript)");
const buildConnector = __turbopack_context__.r("[project]/node_modules/undici/lib/core/connect.js [instrumentation] (ecmascript)");
...
"[project]/node_modules/undici/lib/dispatcher/balanced-pool.js [instrumentation] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";

const { BalancedPoolMissingUpstreamError, InvalidArgumentError } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/errors.js [instrumentation] (ecmascript)");
const { PoolBase, kClients, kNeedDrain, kAddClient, kRemoveClient, kGetDispatcher } = __turbopack_context__.r("[project]/node_modules/undici/lib/dispatcher/pool-base.js [instrumentation] (ecmascript)");
...
"[project]/node_modules/undici/lib/dispatcher/round-robin-pool.js [instrumentation] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/undici/lib/dispatcher/agent.js [instrumentation] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";

const { InvalidArgumentError, MaxOriginsReachedError } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/errors.js [instrumentation] (ecmascript)");
const { kClients, kRunning, kClose, kDestroy, kDispatch, kUrl } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/symbols.js [instrumentation] (ecmascript)");
const DispatcherBase = __turbopack_context__.r("[project]/node_modules/undici/lib/dispatcher/dispatcher-base.js [instrumentation] (ecmascript)");
const Pool = __turbopack_context__.r("[project]/node_modules/undici/lib/dispatcher/pool.js [instrumentation] (ecmascript)");
const Client = __turbopack_context__.r("[project]/node_modules/undici/lib/dispatcher/client.js [instrumentation] (ecmascript)");
const util = __turbopack_context__.r("[project]/node_modules/undici/lib/core/util.js [instrumentation] (ecmascript)");
...
"[project]/node_modules/undici/lib/dispatcher/socks5-proxy-agent.js [instrumentation] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const DispatcherBase = __turbopack_context__.r("[project]/node_modules/undici/lib/dispatcher/dispatcher-base.js [instrumentation] (ecmascript)");
const { InvalidArgumentError } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/errors.js [instrumentation] (ecmascript)");
const { Socks5Client } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/socks5-client.js [instrumentation] (ecmascript)");
const { kDispatch, kClose, kDestroy } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/symbols.js [instrumentation] (ecmascript)");
const Pool = __turbopack_context__.r("[project]/node_modules/undici/lib/dispatcher/pool.js [instrumentation] (ecmascript)");
const buildConnector = __turbopack_context__.r("[project]/node_modules/undici/lib/core/connect.js [instrumentation] (ecmascript)");
...
"[project]/node_modules/undici/lib/dispatcher/proxy-agent.js [instrumentation] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";

const { kProxy, kClose, kDestroy, kDispatch } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/symbols.js [instrumentation] (ecmascript)");
const Agent = __turbopack_context__.r("[project]/node_modules/undici/lib/dispatcher/agent.js [instrumentation] (ecmascript)");
const Pool = __turbopack_context__.r("[project]/node_modules/undici/lib/dispatcher/pool.js [instrumentation] (ecmascript)");
const DispatcherBase = __turbopack_context__.r("[project]/node_modules/undici/lib/dispatcher/dispatcher-base.js [instrumentation] (ecmascript)");
const { InvalidArgumentError, RequestAbortedError, SecureProxyConnectionError } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/errors.js [instrumentation] (ecmascript)");
const buildConnector = __turbopack_context__.r("[project]/node_modules/undici/lib/core/connect.js [instrumentation] (ecmascript)");
const Client = __turbopack_context__.r("[project]/node_modules/undici/lib/dispatcher/client.js [instrumentation] (ecmascript)");
const { channels } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/diagnostics.js [instrumentation] (ecmascript)");
const Socks5ProxyAgent = __turbopack_context__.r("[project]/node_modules/undici/lib/dispatcher/socks5-proxy-agent.js [instrumentation] (ecmascript)");
...
"[project]/node_modules/undici/lib/dispatcher/env-http-proxy-agent.js [instrumentation] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";

const DispatcherBase = __turbopack_context__.r("[project]/node_modules/undici/lib/dispatcher/dispatcher-base.js [instrumentation] (ecmascript)");
const { kClose, kDestroy, kClosed, kDestroyed, kDispatch, kNoProxyAgent, kHttpProxyAgent, kHttpsProxyAgent } = __turbopack_context__.r("[project]/node_modules/undici/lib/core/symbols.js [instrumentation] (ecmascript)");
const ProxyAgent = __turbopack_context__.r("[project]/node_modules/undici/lib/dispatcher/proxy-agent.js [instrumentation] (ecmascript)");
const Agent = __turbopack_context__.r("[project]/node_modules/undici/lib/dispatcher/agent.js [instrumentation] (ecmascript)");
const DEFAULT_PORTS = {
    'http:': 80,
    'https:': 443
...
"[project]/node_modules/undici/lib/dispatcher/retry-agent.js [instrumentation] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/undici/lib/dispatcher/h2c-client.js [instrumentation] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
//# sourceMappingURL=node_modules_undici_lib_dispatcher_c227543e._.js.map