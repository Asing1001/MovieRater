...
let MovieDetailTabs = class MovieDetailTabs extends React.PureComponent {
    ...
    render() {
        ...
        return (React.createElement(Paper_1.default, { zDepth: 2 },
            ...
            React.createElement("div", { className: `swipeViewWrapper active-${this.state.slideIndex}` },
                React.createElement(react_swipeable_views_1.default, { index: this.state.slideIndex, onChangeIndex: this.handleChange.bind(this), threshold: 6 },
