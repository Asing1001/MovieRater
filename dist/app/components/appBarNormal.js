    ...
    render() {
        return (React.createElement(Paper_1.default, { zDepth: 2, className: `appBar normal ${this.props.className}`, style: normalStyles },
            ...
            React.createElement(IconMenu_1.default, { className: "sortingBtn", iconButtonElement: React.createElement(IconButton_1.default, null,
                ...
                React.createElement(MenuItem_1.default, { primaryText: "依IMDB排序", onTouchTap: e => { e.preventDefault(); this.props.switchSorting(sorting_1.SortType.imdb); } }),
                React.createElement(MenuItem_1.default, { primaryText: "依Yahoo排序", onTouchTap: e => { e.preventDefault(); this.props.switchSorting(sorting_1.SortType.yahoo); } }),
                React.createElement(MenuItem_1.default, { primaryText: "依Ptt排序", onTouchTap: e => { e.preventDefault(); this.props.switchSorting(sorting_1.SortType.ptt); } }),
                React.createElement(MenuItem_1.default, { primaryText: "依上映日期排序", onTouchTap: e => { e.preventDefault(); this.props.switchSorting(sorting_1.SortType.releaseDate); } })),
